...
var RolesComponent = /** @class */ (function () {
    function RolesComponent(fb, _crudService) {
        this.fb = fb;
    ...
    RolesComponent.prototype.InitilizeFormItems = function () {
    ...
    RolesComponent.prototype.onSubmit = function (formData) {
        var _this = this;
        this.msg = "";
        switch (this.dbops) {
            case enum_1.DBOperation.create:
                var curl = global_1.Global.BASE_USER_ENDPOINT + "Admin/CreateRole";
            ...
            case enum_1.DBOperation.update:
                var curl = global_1.Global.BASE_USER_ENDPOINT + "Admin/UpdateRole";
                this._crudService.post(curl, formData._value).subscribe(function (data) {
                    if (data == 1) {
            ...
            case enum_1.DBOperation.delete:
                var curl = global_1.Global.BASE_USER_ENDPOINT + "Admin/DeleteRole";
                this._crudService.post(curl, formData._value).subscribe(function (data) {
                    if (data == 1) {
    ...
    RolesComponent.prototype.SetControlsState = function (isEnable) {
    ...
    RolesComponent.prototype.save = function (formData) {
        this.SetControlsState(true);
        this.onSubmit(formData);
    };
    RolesComponent.prototype.onRowSelect = function (event) {
    ...
    RolesComponent.prototype.delete = function () {
        if (confirm("Are you sure to delete ")) {
            this.dbops = enum_1.DBOperation.delete;
            this.onSubmit(this.mainFrm);
        }
    };
    RolesComponent.prototype.showError = function (errormsg) {
        this.msgs = [];
    ...
    RolesComponent = __decorate([
        core_1.Component({
            ...
            templateUrl: 'app/dashboard/Roles/Roles.component.html',
        }),
