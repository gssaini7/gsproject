...
import { RolesModel } from '../../Models/credentials.interface';
    ...
    onSubmit(formData: any) {
        ...
        switch (this.dbops) {
            case DBOperation.create:
                ...
                var curl = Global.BASE_USER_ENDPOINT + "Admin/CreateRole";
            ...
            case DBOperation.update:
                ...
                var curl = Global.BASE_USER_ENDPOINT + "Admin/UpdateRole";
                this._crudService.post(curl, formData._value).subscribe(
                    data => {
                        if (data == 1) //Success
                        {
            ...
            case DBOperation.delete:
                var curl = Global.BASE_USER_ENDPOINT + "Admin/DeleteRole";
