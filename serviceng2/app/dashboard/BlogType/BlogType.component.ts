...
import { BlogTypeModel } from '../../Models/credentials.interface';
...
export class BlogTypeComponent implements OnInit {
    ...
    mainobjlist: BlogTypeModel[];
    mainobj: BlogTypeModel;
    indLoading: boolean = false;
    dbops: DBOperation;
    isNewForm: boolean = false;
    blogProperties: SelectItem[];
    ...
    InitilizeFormItems() {
        this.mainFrm = this.fb.group({
            BlogTypeModelid: [''],
            BlogTypeName: ['', Validators.required],
            BlogTypeDisplayName: ['', Validators.required],
            isPublished: [''],
            remarks: [''],
            BlogTypeProperty: [''],
    ...
    onSubmit(formData: any) {
        ...
        switch (this.dbops) {
            case DBOperation.create:
                ...
                var curl = Global.BASE_USER_ENDPOINT + "BlogType/Create";
            ...
            case DBOperation.update:
                var curl = Global.BASE_USER_ENDPOINT + "BlogType/Edit";
                this._crudService.post(curl, formData._value).subscribe(
                    data => {
                        if (data == 1) //Success
                        {
            ...
            case DBOperation.delete:
                var curl = Global.BASE_USER_ENDPOINT + "BlogType/Delete";
