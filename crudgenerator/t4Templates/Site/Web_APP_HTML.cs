...
<div class=''>
    ...
    <div class=''>
 	...
 	<p-column field="SiteModelid" header="SiteModelid" [sortable]="true"></p-column>
	 
	<p-column field="SiteLogo" header="SiteLogo" [sortable]="true"></p-column>
        ...
        <p-dialog header="Site" [(visible)]="displayDialog" [responsive]="true" showEffect="fade" [modal]="true" [width]="500">
            <form novalidate [formGroup]="mainFrm">

			 	 <div class="form-group">

                    <label for="SiteModelid">SiteModelid</label>
                    <input type="text" class="form-control" id="SiteModelid"  placeholder="Enter SiteModelid" pInputText formControlName="SiteModelid">
                </div>
	 
	 <div class="form-group">

                    <label for="SiteLogo">SiteLogo</label>
                    <input type="text" class="form-control" id="SiteLogo"  placeholder="Enter SiteLogo" pInputText formControlName="SiteLogo">
                </div>
