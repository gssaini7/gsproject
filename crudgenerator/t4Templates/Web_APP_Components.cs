...
import { MenuModel } from '../../Models/credentials.interface';
...
export class MenuComponent implements OnInit {
 ...
 isPublished: [''],
    ...
    LoadData(): void {
        ...
        this._crudService.get(Global.BASE_USER_ENDPOINT + "Menu/GetAll")
            .subscribe(records => {
        ...
        switch (this.dbops) {
            case DBOperation.create:
			 if (formData._value.isPublished == null || formData._value.isPublished == '')
                ...
                var curl = Global.BASE_USER_ENDPOINT + "Menu/Create";
            ...
            case DBOperation.update:
                var curl = Global.BASE_USER_ENDPOINT + "Menu/Edit";
                this._crudService.post(curl, formData._value).subscribe(
                    data => {
                        if (data == 1) //Success
                        {
            ...
            case DBOperation.delete:
                var curl = Global.BASE_USER_ENDPOINT + "Menu/Delete";
