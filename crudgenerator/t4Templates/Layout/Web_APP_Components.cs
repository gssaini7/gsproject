...
import { LayoutModel } from '../../Models/credentials.interface';
...
@Component({
  //selector: 'app-register-form',
    templateUrl: 'app/dashboard/Layout/Layout.component.html',
...
export class LayoutComponent implements OnInit {
 ...
 isPublished: [''],
    ...
    LoadData(): void {
        ...
        this._crudService.get(Global.BASE_USER_ENDPOINT + "Layout/GetAll")
            .subscribe(records => {
        ...
        switch (this.dbops) {
            case DBOperation.create:
			 if (formData._value.isPublished == null || formData._value.isPublished == '')
                ...
                var curl = Global.BASE_USER_ENDPOINT + "Layout/Create";
            ...
            case DBOperation.update:
                var curl = Global.BASE_USER_ENDPOINT + "Layout/Edit";
                this._crudService.post(curl, formData._value).subscribe(
                    data => {
                        if (data == 1) //Success
                        {
            ...
            case DBOperation.delete:
                var curl = Global.BASE_USER_ENDPOINT + "Layout/Delete";
