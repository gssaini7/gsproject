...
<div class=''>
    ...
    <div class=''>
 	...
 	<p-column field="LayoutModelid" header="LayoutModelid" [sortable]="true"></p-column>
	 
	<p-column field="LayoutName" header="LayoutName" [sortable]="true"></p-column>
        ...
        <p-dialog header="Layout" [(visible)]="displayDialog" [responsive]="true" showEffect="fade" [modal]="true" [width]="500">
            <form novalidate [formGroup]="mainFrm">

			 	 <div class="form-group">

                    <label for="LayoutModelid">LayoutModelid</label>
                    <input type="text" class="form-control" id="LayoutModelid"  placeholder="Enter LayoutModelid" pInputText formControlName="LayoutModelid">
                </div>
	 
	 <div class="form-group">

                    <label for="LayoutName">LayoutName</label>
                    <input type="text" class="form-control" id="LayoutName"  placeholder="Enter LayoutName" pInputText formControlName="LayoutName">
                </div>
