...
import { MenuItemModel } from '../../Models/credentials.interface';
...
export class MenuItemComponent implements OnInit {
 ...
 isPublished: [''],
    ...
    LoadData(): void {
        ...
        this._crudService.get(Global.BASE_USER_ENDPOINT + "MenuItem/GetAll")
            .subscribe(records => {
