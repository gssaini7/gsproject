...
<div class=''>
    ...
    <div class=''>
 	...
 	<p-column field="AlbumModelid" header="AlbumModelid" [sortable]="true"></p-column>
	 
	<p-column field="AlbumName" header="AlbumName" [sortable]="true"></p-column>
        ...
        <p-dialog header="Album" [(visible)]="displayDialog" [responsive]="true" showEffect="fade" [modal]="true" [width]="500">
            <form novalidate [formGroup]="mainFrm">

			 	 <div class="form-group">

                    <label for="AlbumModelid">AlbumModelid</label>
                    <input type="text" class="form-control" id="AlbumModelid"  placeholder="Enter AlbumModelid" pInputText formControlName="AlbumModelid">
                </div>
	 
	 <div class="form-group">

                    <label for="AlbumName">AlbumName</label>
                    <input type="text" class="form-control" id="AlbumName"  placeholder="Enter AlbumName" pInputText formControlName="AlbumName">
                </div>
