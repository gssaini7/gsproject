...
<div class=''>
    ...
    <div class=''>
 	...
 	<p-column field="BlogTypeid" header="BlogTypeid" [sortable]="true"></p-column>
	 
	<p-column field="BlogTypeName" header="BlogTypeName" [sortable]="true"></p-column>
        ...
        <p-dialog header="BlogType" [(visible)]="displayDialog" [responsive]="true" showEffect="fade" [modal]="true" [width]="500">
            <form novalidate [formGroup]="mainFrm">

			 	 <div class="form-group">

                    <label for="BlogTypeid">BlogTypeid</label>
                    <input type="text" class="form-control" id="BlogTypeid"  placeholder="Enter BlogTypeid" pInputText formControlName="BlogTypeid">
                </div>
	 
	 <div class="form-group">

                    <label for="BlogTypeName">BlogTypeName</label>
                    <input type="text" class="form-control" id="BlogTypeName"  placeholder="Enter BlogTypeName" pInputText formControlName="BlogTypeName">
                </div>
