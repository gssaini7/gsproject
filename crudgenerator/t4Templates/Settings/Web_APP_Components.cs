...
import { SettingsModel } from '../../Models/credentials.interface';
...
export class SettingsComponent implements OnInit {
    ...
    mainobjlist: SettingsModel[];
    mainobj: SettingsModel;
 ...
 isPublished: [''],
    ...
    LoadData(): void {
        ...
        this._crudService.get(Global.BASE_USER_ENDPOINT + "Settings/GetAll")
            .subscribe(records => {
