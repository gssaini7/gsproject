...
<div class=''>
    ...
    <div class=''>
 	...
 	<p-column field="NotificationScheduleModelid" header="NotificationScheduleModelid" [sortable]="true"></p-column>
	 
	<p-column field="notificationsentdate" header="notificationsentdate" [sortable]="true"></p-column>
	 
	<p-column field="classname" header="classname" [sortable]="true"></p-column>
