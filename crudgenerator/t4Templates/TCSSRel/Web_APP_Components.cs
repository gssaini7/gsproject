...
import { TCSSRelModel } from '../../Models/credentials.interface';
...
@Component({
  //selector: 'app-register-form',
    templateUrl: 'app/dashboard/TCSSRel/TCSSRel.component.html',
...
export class TCSSRelComponent implements OnInit {
 ...
 isPublished: [''],
    ...
    LoadData(): void {
        ...
        this._crudService.get(Global.BASE_USER_ENDPOINT + "TCSSRel/GetAll")
            .subscribe(records => {
