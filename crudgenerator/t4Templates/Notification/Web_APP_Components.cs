...
import { NotificationModel } from '../../Models/credentials.interface';
...
export class NotificationComponent implements OnInit {
    ...
    mainobjlist: NotificationModel[];
    mainobj: NotificationModel;
 ...
 isPublished: [''],
    ...
    LoadData(): void {
        ...
        this._crudService.get(Global.BASE_USER_ENDPOINT + "Notification/GetAll")
            .subscribe(records => {
        ...
        switch (this.dbops) {
            case DBOperation.create:
			 if (formData._value.isPublished == null || formData._value.isPublished == '')
                ...
                var curl = Global.BASE_USER_ENDPOINT + "Notification/Create";
            ...
            case DBOperation.update:
                var curl = Global.BASE_USER_ENDPOINT + "Notification/Edit";
                this._crudService.post(curl, formData._value).subscribe(
                    data => {
                        if (data == 1) //Success
                        {
            ...
            case DBOperation.delete:
                var curl = Global.BASE_USER_ENDPOINT + "Notification/Delete";
