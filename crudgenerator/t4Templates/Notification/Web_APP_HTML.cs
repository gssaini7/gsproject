...
<div class=''>
    ...
    <div class=''>
 	...
 	<p-column field="Notificationid" header="Notificationid" [sortable]="true"></p-column>
	...
	<p-column field="imagepath" header="imagepath" [sortable]="true"></p-column>
        ...
        <p-dialog header="Notification" [(visible)]="displayDialog" [responsive]="true" showEffect="fade" [modal]="true" [width]="500">
            <form novalidate [formGroup]="mainFrm">

			 	 <div class="form-group">

                    <label for="Notificationid">Notificationid</label>
                    <input type="text" class="form-control" id="Notificationid"  placeholder="Enter Notificationid" pInputText formControlName="Notificationid">
                </div>
	 ...
	 <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="description"  placeholder="Enter description" pInputText formControlName="description">
                </div>
	 
	 <div class="form-group">

                    <label for="imagepath">imagepath</label>
                    <input type="text" class="form-control" id="imagepath"  placeholder="Enter imagepath" pInputText formControlName="imagepath">
                </div>
